  ...
  return (
    <section className='flex flex-col p-10 max-sm:p-5 lg:p-20 lg:pb-10  bg-gradient-to-r from-black via-gray-950 to-black '>
      ...
      <div className='lg:flex justify-between itetms-center '>
        <h2 className='text-5xl max-sm:text-4xl font-bold pb-5 md:w-[450px]'>¿Listo para transformar tu negocio?</h2>
        <div className='lg:flex flex-col justify-center'>
          ...
          <a
						href="#get-started"
						className="group relative inline-flex items-center text-center px-6 py-3 overflow-hidden rounded-full text-white text-lg max-sm:text-base font-medium"
					>
